...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-05-2024 a las 23:30:49
...
ALTER TABLE `inscripcion`
  ...
  ADD CONSTRAINT `inscripcion_ibfk_2` FOREIGN KEY (`idAlumno`) REFERENCES `alumnos` (`idAlumno`);
COMMIT;
